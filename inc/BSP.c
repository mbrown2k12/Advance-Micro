...
#define SELECT1   (*((volatile uint8_t *)(0x42000000+32*0x4C20+4*5)))  /* Port 3.5 Input */
void BSP_Joystick_Input(uint16_t *x, uint16_t *y, uint8_t *select, uint8_t *select1){
  ...
  *select1 = SELECT1;                // return 0(pressed) or 0x01(not pressed)
